...
namespace SistemaInventario.Areas.Admin.Controllers
{
    ...
    public class BodegaController : Controller
    {
        ...
        public async Task<IActionResult> Upsert(int? id) {
            ...
            //Actualizamos
            //nos ayuda a evitar que si el id es nulo nos salga este error
        ...
        #region API
        [HttpGet]
        //el IActionResult no solo retorna una lista o vista sino tambien objetos en formato json
        ...
        public async Task<IActionResult> Delete(int id) {
            ...
            await _unidadTrabajo.Guardar();
            return Json(new {success=true,message="Bodega borrado exitosamente"});
